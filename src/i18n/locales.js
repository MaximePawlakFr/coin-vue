export default {
  fr: {
    message: {
      ...
      none: "Aucun",
      fetchData: "Afficher les données",
      from: "Du",
      to: "Au",
      station: "Station",
      parametersDefinition: "Définition des paramètres",
      all: "Tous",
      step1: "1. Sélectionner une station",
      step2: "2. Sélectionner un dataset",
      step3: "3. Sélectionner les paramètres",
      step4: "4. Sélectionner une période temporelle",
    ...
    parameters: {
      ...
      windSpeedAt10m: "Vitesse du vent à 10m",
      windSpeedAt2m: "Vitesse du vent à 2m",
      humidityMin: "Humidité minimale",
      humidityMax: "Humidité maximale",
      humidityAvg: "Humidité moyenne",
      vaporPressureAvg: "Tension de vapeur moyenne",
    },
    brevoForm: {
      title: "Accès Premium",
      description:
        "Inscrivez-vous et obtenez un accès aux fonctionnalités premium.",
  ...
  <a href="https://www.brevo.com/en/legal/privacypolicy/" target="_blank"
  ...
  en: {
    message: {
      ...
      to: "To",
      station: "Station",
      parametersDefinition: "Parameters definition",
      all: "All",
      step1: "1. Select a station",
      step2: "2. Select a dataset",
      step3: "3. Select parameters",
      step4: "4. Select a periode",
    ...
    parameters: {
      ...
      windSpeedAt10m: "Wind Speed at 10m",
      windSpeedAt2m: "Wind Speed at 2m",
      humidityMin: "Humidity Min",
      humidityMax: "Humidity Max",
      humidityAvg: "Humidity Avg",
      vaporPressureAvg: "Vapor Pressure Avg",
    },
    brevoForm: {
